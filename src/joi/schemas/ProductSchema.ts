...
export class ProductSchema {
  ...
  static update = Joi.object({
    id: this.id.required().error((errors) => this.errorHandler(errors, 'id')),
    title: this.text.optional().error((errors) => this.errorHandler(errors, 'title')),
    price: this.numeric.optional().error((errors) => this.errorHandler(errors, 'price')),
    categoryId: this.id.optional().error((errors) => this.errorHandler(errors, 'categoryId')),
  })
